...
import { sealAllBracketMatchRows } from "@/lib/tournament-match-outcome";
...
export function evaluateBracketPoolPlay(bracket, pairById, options = {}) {
  ...
  const matches = options.resetScores
    ? mergeRoundRobinSchedule(bracket.matches, bracket.pairIds, {
        resetScores: true,
        scheduleResetAt,
